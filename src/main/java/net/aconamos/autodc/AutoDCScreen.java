...
public class AutoDCScreen extends Screen {
    ...
    public final void init() {
        this.enableButton = new ButtonWidget(this.width / 2 - 100, this.height / 2, 98, 20, Text.of("AutoDC: " + Config.AutoDCEnabled), (button) -> {
            Config.AutoDCEnabled = !Config.AutoDCEnabled;
            button.setMessage(Text.of("AutoDC: " + Config.AutoDCEnabled));
        });
